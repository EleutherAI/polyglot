...
💡 We are collaborating with KoAlpaca team which is creating a series of Korean instruct fine-tuned models. As a result, we were able to release the Koalapca-Polyglot model. Please refer to [here](https://github.com/Beomi/KoAlpaca) to see more details.
